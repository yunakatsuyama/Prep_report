...
WHO published air quality guidline. 
Most of global population live in the air condition which is worse than AQG. 
Figure which I use on the presentation 
...
Air pollutants can be grouped into two, primary and secondary pollutanst. Primary pollutants are emitted from source and secondary pollutants are chemically produced  from the primary pollutant. 
...
Machine learning is a method to derive the expected result without programming explicitly. Basement of machine learning is linear regression. Neural network is a machine learning 
